...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Update Student marks</p>
          <div class="clr"></div>
...
<body bgcolor=#FFFFFF >
		<?php
			...
			{	
				...
				$sql="SELECT * from iamarks where studentid='$uid'";
				...
				while($row=mysqli_fetch_assoc($result)){
					...
					$path = "smarksedit1.php?uid=".$row['studentid'];
					}
				
				echo "<tr><td height='51'></td><td><button name='edit'  /><a href='$path'>Edit</a></button>";
				echo "<tr><td height='51'></td><td><input name='edit' type='submit'  id='edit' value='Delete' onclick='smarksedit.php' />";
				echo"</table>";
				echo "</form>";
