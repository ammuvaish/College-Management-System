...
echo "<tr><td width='241'><div align='center'><span class='style3'>Subject</span></div></td><td width='241'><div align='center'><span class='style3'>Teacher</span></div></td>";
while($row=mysqli_fetch_assoc($result)){
	echo "<tr><td width='241'><div align='center'><span class='style3'>{$row['subject']}</span></div></td><td width='241'><div align='center'><span class='style3'>{$row['teacher']}</span></div></td></tr>";
}
echo"</table>";
