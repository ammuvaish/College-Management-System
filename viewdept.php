...
<body bgcolor=#FFFFFF >
<p align="center" class="style4">Department List</p>
<?php
...
echo "<tr><td width='241'><div align='center'><span class='style3'>Name</span></div></td><td width='241'><div align='center'><span class='style3'>Code</span></div></td><td width='241'><div align='center'><span class='style3'>Phone</span></div></td><td width='241'><div align='center'><span class='style3'>Office</span></div></td>";
while($row=mysqli_fetch_assoc($result)){
	echo "<tr><td width='241'><div align='center'><span class='style3'>{$row['name']}</span></div></td><td width='241'><div align='center'><span class='style3'>{$row['code']}</span></div></td><td width='241'><div align='center'><span class='style3'>{$row['phone']}</span></div></td><td width='241'><div align='center'><span class='style3'>{$row['office']}</span></div></td>";
}
echo"</table>";
