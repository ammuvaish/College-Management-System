...
if($_POST['imageField'])
{
	...
	$sql="INSERT INTO teacher(tuserid,tname,tphone,salary,designation) VALUES ('$_POST[id]','$_POST[name]','$_POST[phone]','$_POST[salary]','$_POST[designation]');";
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Teacher Registration Form </p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          ...
          <div class="post_content">
            <p align="justify"> 
              ...
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Teacher ID </strong></span></td>
                  ...
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Salary</strong> </span></td>
                    <td><input type="text" id="name" name="salary" class="text" /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong> Designation </strong></span></td>
                    <td width="251"><input id="name" name="designation" type="text" /></td>
                  </tr>
