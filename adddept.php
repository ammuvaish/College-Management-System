...
if($_POST['imageField'])
{
	...
	$sql="INSERT INTO department VALUES ('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]');";
...
<div class="main">
	 ...
	 <div class="logo">
      ...
      <div class="menu_nav">
        <ul>
		  ...
		  <li><a href="teacherlogin.jsp"><span>Teacher</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Department Registration Form </p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          
		
          <div class="post_content">
            <p align="justify"> <form  method="post">
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Department name </strong></span></td>
                    <td width="251"><input id="name" name="a" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Department Code</strong> </span></td>
                    <td><input type="text" id="name" name="b" class="text" /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Phone </strong></span></td>
                    <td width="251"><input id="name" name="c" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Department Office </strong> </span></td>
                    <td><input type="text" id="name" name="d" class="text" /></td>
                  </tr>
