...
if($_POST['imageField'])
{
	...
	$sql="INSERT INTO section VALUES ('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]');";
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Section Registration Form </p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          ...
          <div class="post_content">
            <p align="justify"> <form method="post">
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style5" ><strong>Section ID </strong></span></td>
                    <td width="251"><input id="name" name="a" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style4"> <strong>Section  Name </strong></span></td>
                    <td><input type="text" id="name" name="b" class="text" /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Year</strong></span></td>
                    <td width="251"><input id="name" name="c" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Semester</strong></span></td>
