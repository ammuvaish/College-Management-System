...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Assigns students to section</p>

<p align="justify"> 
    <form action="assstsec1.php" method="post">
<table width="92%">
				  ...
				  <tr>
                    <td height="44"><span class="style1 style5"><strong>Section Name</strong> </span></td>
                    <td><input type="text" id="sid" name="sid" class="text"  /></td>
                  </tr>
