...
echo "<tr><td width='241'><div align='center'><span class='style3'>Code</span></div></td><td width='241'><div align='center'><span class='style3'>Name</span></div></td><td width='241'><div align='center'><span class='style3'>Credits</span></div></td>";
while($row=mysqli_fetch_assoc($result)){
	echo "<tr><td width='241'><div align='center'><span class='style3'>{$row['ccode']}</span></div></td><td width='241'><div align='center'><span class='style3'>{$row['name']}</span></div></td><td width='241'><div align='center'><span class='style3'>{$row['credits']}</span></div></td>";
}
echo"</table>";
