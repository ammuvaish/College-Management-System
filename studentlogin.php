...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Welcome to Student Login </p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <div class="img"><img src="images/img2.jpg" width="177" height="213" alt="" class="fl" /></div>
		
          <div class="post_content">
            <p align="justify"> <form action="studentlogin.php" method="post">
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Student Name (<span class="style6">required</span>)</strong></span></td>
