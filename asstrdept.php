...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Assigns teacher to department</p>

<p align="justify"> 
    <form action="asstrdept1.php" method="post">
<table width="92%">
               
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Department ID</strong> </span></td>
                    <td><input type="text" id="did" name="did" class="text"  /></td>
                  </tr>
				  <tr>
