                 ...
                 <?php
				  ...
				  <tr>
                   ...
                   <tr>
                    ...
                    <td width="251"><input id="txt2" name="address" type="text"  /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Phone</strong> </span></td>
                    <td><input type="text" id="txt3" name="phone" class="text"  /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong> DOB </strong></span></td>
                    <td width="251"><input id="txt4" name="salary" type="text" /></td>
                  </tr>
                  <tr>
