...
if($_POST['imageField'])
{
	...
	$sql="INSERT INTO course VALUES ('$_POST[a]','$_POST[b]','$_POST[c]');";
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Course Registration Form </p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          ...
          <div class="post_content">
            <p align="justify"> <form  method="post">
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Course Code </strong></span></td>
                    <td width="251"><input id="name" name="a" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"> <strong>Course Name</strong> </span></td>
                    <td><input type="text" id="password" name="b" class="text" /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Credits</strong></span></td>
