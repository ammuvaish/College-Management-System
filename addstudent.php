...
if($_POST['imageField'])
{
	...
	$sql="INSERT INTO student(userid,name,phone,dob,address,sex) VALUES ('$_POST[id]','$_POST[name]','$_POST[phone]','$_POST[dob]','$_POST[address]', '$_POST[sex]');";
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost style3">Student Registration Form </p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          ...
          <div class="post_content">
            <p align="justify"> 
              ...
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Student ID </strong></span></td>
                    <td width="251"><input id="name" name="id" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Name</strong> </span></td>
                    <td><input type="text" id="name" name="name" class="text" /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Phone </strong></span></td>
                    <td width="251"><input id="name" name="phone" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Date Of Birth</strong> </span></td>
                    <td><input type="text" id="name" name="dob" class="text" /></td>
                  </tr>
				  
				  <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong> Address </strong></span></td>
                    <td width="251"><input id="name" name="address" type="text" /></td>
                  </tr>
                  <tr>
                    <td height="44"><span class="style1 style5"><strong>Sex</strong> </span></td>
                    <td><input type="text" id="name" name="sex" class="text" /></td>
                  </tr>
