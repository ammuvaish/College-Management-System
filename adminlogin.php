      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content">
            <p align="justify"> <form action="adminlogin.php" method="post">
              <table width="92%">
                 <tr>
                    <td width="175" height="48"><span class="style1 style4" ><strong>Admin Name (<span class="style6">required</span>)</strong></span></td>
