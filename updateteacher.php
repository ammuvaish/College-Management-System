...
<body bgcolor=#FFFFFF >
		<?php
			...
			{	
				...
				$sql="SELECT * from teacher where tuserid='$uid'";
				$result=mysqli_query($connection,$sql);
				echo "<form  method='post'  >";
				echo "<table width='600' border='1' align='center'>";
				echo "<tr><td width='241'><div align='center'><span class='style3'>Teacher ID</span></div></td><td width='241'><div align='center'><span class='style3'>Name</span></div></td><td width='241'><div align='center'><span class='style3'>Phone</span></div></td><td width='241'><div align='center'><span class='style3'>Salary</span></div></td><td width='241'><div align='center'><span class='style3'>Designation </span></div></td>";
				while($row=mysqli_fetch_assoc($result)){
					...
					$path = "updateteacher1.php?uid=".$row['tuserid'];
                    $path2="deleteteacher.php?uid=".$row['tuserid'];
					}
